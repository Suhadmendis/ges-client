...
<html lang="zxx" class="no-js">
  ...
  <body>
        ...
        <div class="row d-flex align-items-center justify-content-center">
          <div class="about-content col-lg-12">
            ...
            <p class="text-white link-nav">
              ...
              <a href="contact.html">School of Management </a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="faculty-wrap">
        <div class="first-faculty-section">
          <div class="faculty-card">
            <div class="faculty-title">School of Management</div>
            <div style="display:grid">
              ...
              <button
                ...
                onclick="openCity(event,'bm')"
              >
                Business Management
              </button>
              <button
                class="w3-bar-item w3-button tablink"
                onclick="openCity(event,'bc')"
              >
                Hospitality and Tourism
              </button>
              <button
                class="w3-bar-item w3-button tablink"
                onclick="openCity(event,'ls')"
              >
        ...
        <div class="faculty-des">
          <div id="if" class="w3-container w3-border city">
            <li class="link-it">
              <a href="#">Business Pathway</a>
            </li>
            <li class="link-it">
              <a href="#">IT Pathway</a>
            </li>
            <li class="link-it">
              <a href="#">Finance Pathway</a>
            </li>
            <li class="link-it">
              <a href="#">Law Pathway</a>
            </li>
          </div>

          <div id="bm" class="w3-container w3-border city" style="display:none">
            <ul>
              <li class="link-it">
                <a href="#"
                  >International Foundation (Business / Finance Pathway) (Level
                  3)</a
                >
              </li>
              <li class="link-it">
                <a href="#"
                  >Advance Diploma / HND in Business Management (Level 5)
                </a>
              </li>
              <li class="link-it">
                <a href="#"
              ...
              <li class="link-it">
                <a href="#"
                  >Postgraduate Diploma in Strategic Management & Leadership
                  (Level 7)</a
                >
              </li>
              <li class="link-it">
          ...
          <div id="bc" class="w3-container w3-border city" style="display:none">
            <ul>
              <li class="link-it">
                <a href="#"
              ...
              <li class="link-it">
                <a href="#"
                  >Graduate Diploma in Hospitality and Tourism Management (Level
                  6)</a
                >
              </li>
              <li class="link-it">
          ...
          <div id="ls" class="w3-container w3-border city" style="display:none">
            <ul>
              <li class="link-it">
                <a href="#"
                  >Advance Diploma / HND in Logistics & Supply Chain Management
                  (Level 5)</a
                >
              </li>
              <li class="link-it">
    ...
    <style>
      ...
      .w3-hover-red:hover {
        color: #fff !important;
        background-color: #240c5a !important;
      }
      .w3-sand,
      .w3-hover-sand:hover {
        color: #000 !important;
